package cn.com.sky.patterns.structural.bridge.demo2;

import cn.com.sky.patterns.structural.bridge.demo2.abstraction.Abstraction;
import cn.com.sky.patterns.structural.bridge.demo2.abstraction.RefinedAbstraction;
import cn.com.sky.patterns.structural.bridge.demo2.implement.ConcreteImplementorA;
 ...
 * 换言之，抽象化角色的接口比实现化角色的接口宽。抽象化角色除了提供与实现化角色相关的方法之外，还有可能提供其他的方法；
